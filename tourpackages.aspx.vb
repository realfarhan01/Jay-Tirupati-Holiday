    ...
    Sub BindData()
        ...
        If Not Request.QueryString("page") Is Nothing Then
            ...
            If PageName <> "" Then
                ...
                LitHead.Text = BLL.ExecScalar("Select MetaTags from tbl_ProductCategory Where PageURL=@PageURL and DeActivated=0", "@PageURL", PageName)
                ...
                Else
                    BannerImage = "'background-image: url(../img/banner/banner-03.jpg) !important;min-height: 500px !important;'"
                End If
